...
def calculate_transformation(points1, points2):
    """Calculate homography transformation from calibration points"""
...
def apply_transformation(image_path, matrix, target_size):
...
def generate_layers(comp_id, img1_path, img2_path, transformation_matrix=None):
    ...
    if transformation_matrix is not None:
        h2, w2 = img2.shape[:2]
        img1 = apply_transformation(img1_path, transformation_matrix, (w2, h2))
        if img1 is None:
            return False
...
def calibrate():
    ...
    transformation = calculate_transformation(points1, points2)
